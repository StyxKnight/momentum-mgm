...
async def create_report_slides(neighborhood: str) -> str:
    ...
    score_block = scores.get("scores", scores)  # handle nested or flat
    ...
    slides_data = [
        {
            ...
            "body": [
                ...
                f"ADI Score: {adi.get('score', 'N/A')} — {adi.get('severity', '')}",
                f"SVI Score: {svi.get('score', 'N/A')} — {svi.get('severity', '')}",
                f"EJI Score: {eji.get('score', 'N/A')} — {eji.get('severity', '')}",
                "",
        ...
        },
        {
            ...
            "body": [
                f"Area Deprivation Index (ADI): {adi.get('score', 'N/A')} — {adi.get('severity', 'N/A')}",
                f"  {adi.get('interpretation', '')}",
                "",
                f"Social Vulnerability Index (SVI): {svi.get('score', 'N/A')} — {svi.get('severity', 'N/A')}",
                f"  {svi.get('interpretation', '')}",
                "",
                f"Environmental Justice Index (EJI): {eji.get('score', 'N/A')} — {eji.get('severity', 'N/A')}",
